...
if Arduino.isOpen():
    ...
    while True:
            ...
            print('LightDetector  ='+ outputInString)
            
            data = [{"Id__c": "1", 'LightOn__c': outputInString}]# De field die in Salesforce zijn aangemaakt geef ik hier terug met de juiste data en de data dat van arduino komt (Outputstring)
            sf.bulk.LightSensor__e.insert(data)# Het doorsturen van data naar Salesforce
