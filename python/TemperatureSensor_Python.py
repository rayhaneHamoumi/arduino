...
if Arduino.isOpen():
    ...
    while True:
            ...
            print('Temperature  ='+ outputInString)
            
            data = [{"Id__c": "1", 'Temperature__c': outputInString}]# De field die in Salesforce zijn aangemaakt geef ik hier terug met de juiste data en de data dat van arduino komt (Outputstring)
            sf.bulk.TemperatureSensor__e.insert(data)# Het doorsturen van data naar Salesforce
